...
ggboxplot(gemiddelde_port, x = "Geslacht", y = "Gemiddelde", 
...
#H0: het verschil tussen de gemiddelde cijfers van portugees tussen man en vrouw is gelijk.
#H1: het verschil tussen de gemiddelde cijfers van portugees tussen man en vrouw is ongelijk.
...
#H0: er zit geen verschil tussen de gemiddeldes tussen G1.wis, G2.wis en G3.wis.
#H1: er zit minimaal één verschil tussen de gemiddeldes tussen G1.wis, G2.wis en G3.wis.
...
summary(res.aov)
```
#uit deze tabel is te zien dat de P-waarde groter is dan de 0.05. dat betekend dat de H0 hypothese verworpen wordt. Er is dus geen significant verschil tussen het toetsnummer en het cijfer wat behaald wordt.
```{r include = FALSE}
...
method = "pearson")
```
##correlatie tussen wiskunde en portugees.

Er word gekeken of een goed cijfer voor wiskunde ook betekend dat er een goed cijfer voor portugees word gehaald. Hierbij wordt de volgende hypothese opgeteld:
